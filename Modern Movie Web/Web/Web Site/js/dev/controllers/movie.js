...
(function () {
    ...
    movieApp.fn.movie = movieController.extend({

        onload: function (response) {

            var mv = this;

            if (!response.paramValues || !response.paramValues.id) {
                mv.rootScope.showError("No Movie Id Requested");
                return;
            }

            mv.isVisible = true;

            mData.loadMovieDetails(response.paramValues.id, function (movie) {

                if (!movie) {
                    return;
                }

                mv.renderMovieDetails(movie);
        ...
        renderMovieDetails: function (data) {
            ...
            if (data) {
                ...
                mv.rootScope.viewEngine.bind(detailPanel, "movieDetailsPosterTemplate", data);
                mv.rootScope.viewEngine.bind(movieDesc, "movieDetailsDescriptionTemplate", data);
                mv.rootScope.viewEngine.bind(castNames, "movieDetailsCastTemplate", data);
                mv.rootScope.viewEngine.bind(showTimes, "MovieShowtimeTemplate", data);

                mv.rootScope.setMainTitle(data.title);
                ...
                mv.rootScope.setupPanorama(".panorama-container", { maxWidth: smallBreakpoint });
        ...
        renderSmallScreen: function () {
            ...
            mv.rootScope.panorama.resizePanorama();
        ...
        renderMiniTablet: function () {
            ...
            this.rootScope.panorama.resizePanorama();
        },
